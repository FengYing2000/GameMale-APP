...
<tr>
<td><b>✍️ 发言</b></td>
<td>回复、引用回复、发表新主题、编辑自己的帖子。内置<b>表情选择器</b>与 BBCode 快捷键，回帖有奖励时会直接显示横幅。已经回过的主题会标「已回」。回复页会显示<b>字数</b>、不到论坛下限先提醒；主题关闭或达每日回帖上限时直接显示论坛给的原因，发送后<b>确认真的有发出去</b>才算成功。</td>
</tr>
<tr>
<td><b>⭐ 互动</b></td>
...
<tr>
<td><b>🎨 个性化</b></td>
<td>深色／浅色主题、<b>彩虹旗六色</b>强调色任选、繁简体即时切换、图片加载策略（一律加载／只在 Wi-Fi／手动）。长按图片可以保存、分享或复制链接。原生版支持<b>多账号切换</b>（可选记住密码，存在设备的安全区、不上传）。</td>
</tr>
</table>
